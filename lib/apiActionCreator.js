...
function validateConfig(configs, options) {
  Object.keys(configs).forEach(function (creatorName) {
    ...
    var configName = '' + (options && options.prefix) + (0, _asyncActionHelpers.parseToUppercase)(creatorName);
...
function createApiActions(config, options) {
  ...
  var actionTypes = (0, _asyncActionHelpers.createTypes)(actionKeys, options && options.prefix);
  var creators = (0, _asyncActionHelpers.createCreators)(config, actionTypes, options.prefix, apiActionCreatorFactory);
